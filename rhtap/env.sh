...
export GITOPS_REPO_URL=https://github.com/prietyc123-qe-org/test-py-16-azr-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-tssc-tas.apps.cluster-rsbs9.rsbs9.sandbox2247.opentlc.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-tssc-tas.apps.cluster-rsbs9.rsbs9.sandbox2247.opentlc.com}
